...
var queryChaincode = async function(peer, channelName, chaincodeName, args, fcn, username, org_name) {
	...
	try {
		...
		if (response_payloads) {
			...
			let response = Object.values(JSON.parse(response_payloads.toString('utf8'))[0])
			return Object.values(JSON.parse(response_payloads.toString('utf8'))[0])[0];//JSON.parse(response_payloads.toString('utf8'));
